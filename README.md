# Olá, sou Samuel Rodrigues! 👋

Sou graduando do **7º semestre de Ciência da Computação** e atuo como **Assistente de Desenvolvimento de Dados**, desenvolvendo soluções que conectam engenharia de dados, análise, automação, Business Intelligence e desenvolvimento de software.
Tenho experiência prática na construção e sustentação de **pipelines ETL/ELT**, APIs de dados, dashboards e automações utilizando **Python, SQL, Apache Airflow, Spark, Docker e Power BI**.
Também desenvolvo soluções de automação com Python, Selenium e web scraping, além de possuir formação Full Stack, o que me permite compreender o fluxo completo entre banco de dados, backend, frontend e visualização das informações.
